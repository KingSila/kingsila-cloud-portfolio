...
resource "azurerm_linux_web_app" "app" {
  ...
  # 🔹 Switch from SystemAssigned → UserAssigned MI from module.mi_app_test
  identity {
    type         = "UserAssigned"
    identity_ids = [module.mi_app_test.identity_id]
  }
  ...
  app_settings = {
    ...
    ConnectionStrings__Db = "@Microsoft.KeyVault(SecretUri=${azurerm_key_vault_secret.test_connection_string.id})"
  }
