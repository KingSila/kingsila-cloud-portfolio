...
Azure infrastructure deployment for the **KingSila Cloud Portfolio** test environment.
...
```text
rg-kingsila-test (Resource Group)
├── vnet-kingsila-test (10.20.0.0/16)
│   ├── app subnet (10.20.1.0/24)
│   ├── data subnet (10.20.2.0/24)
│   └── appsvc subnet (10.20.20.0/27) [delegated to Microsoft.Web]
├── nsg-app-test (Network Security Group)
│   ├── Allow SSH (port 22)
│   └── Allow RDP (port 3389)
└── test-route-table (Route Table)
```
